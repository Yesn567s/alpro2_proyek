...
public class App {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (minSteps < Integer.MAX_VALUE) {
            ...
            if (mapChoice == 3 || mapChoice == 4 || mapChoice == 5 || mapChoice == 6) {
        ...
        char[][] pathMap
            ...
            if (map[r][c] == '1' && portal2 != null) {
                ...
                if (destRow >= 0 && !FileReader2DArray.isWall(map, destRow, destCol)) {
                    System.out.println("Portal used: from (1) at (" + r + "," + c + ") to above (2) at (" + destRow + "," + destCol + ")");
            ...
            if (map[r][c] == '2' && portal1 != null) {
                ...
                if (destRow >= 0 && !FileReader2DArray.isWall(map, destRow, destCol)) {
                    System.out.println("Portal used: from (2) at (" + r + "," + c + ") to above (1) at (" + destRow + "," + destCol + ")");
                    backtrackMap6(map, visited, destRow, destCol, steps + 1, hasKey, health, hasPickaxe, hasSword, gold, pathMap);
                    return;
                }
            }
            ...
            for (int d = 0; d < 4; d++) {
                ...
                // Check if can step
                boolean canStep = false;
                if (afterMove == ' ' || afterMove == 'K' || afterMove == 'E' || afterMove == 'L' || afterMove == 'X' || afterMove == 'G' || afterMove == 'N' || afterMove == 'W' || afterMove == 'M' || afterMove == '1' || afterMove == '2') {
                    canStep = true;
                } else if (afterMove == 'O') {
                    canStep = true; // log on water
                } else if (afterMove == 'A') {
